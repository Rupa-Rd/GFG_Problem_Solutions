    ...
    int intersectPoint(Node head1, Node head2) {
       if (head1 == null || head2 == null) return -1;
        ...
        while (pA != pB) {
            ...
            pA = (pA != null) ? pA.next : head1;
            pB = (pB != null) ? pB.next : head2;
        }

        // If they intersect, pA (or pB) will be at the intersection node, otherwise they will be null
        return (pA != null) ? pA.data : -1;
    }
}
