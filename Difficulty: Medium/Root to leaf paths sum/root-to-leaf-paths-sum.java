...
class Solution {
    ...
    public static int calculateSum(Node node, int currentSum){
        if (node == null) {
            return 0;
        }

        // Update the current sum by considering the current node's value
        ...
        // Return the sum of left and right subtree paths
